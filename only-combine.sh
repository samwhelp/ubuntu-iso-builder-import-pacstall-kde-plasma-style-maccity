...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-kde-plasma-style-maccity"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-kde-plasma-style-maccity/iso-profile
"
echo
